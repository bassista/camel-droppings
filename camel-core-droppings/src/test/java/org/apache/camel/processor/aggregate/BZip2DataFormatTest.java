...
import org.apache.camel.impl.BZip2DataFormat;
import org.apache.camel.util.IOHelper;
import org.apache.commons.compress.compressors.bzip2.BZip2CompressorOutputStream;

public class BZip2DataFormatTest extends ContextTestSupport {
    ...
    return new RouteBuilder() {
      ...
      public void configure() throws Exception {
        from("direct:startMarshal")
          .marshal(new BZip2DataFormat())
          //.to("file:///tmp/?fileName=test.bz2")
          .to("mock:endMarshal");

        from("direct:startUnmarshal")
          .unmarshal(new BZip2DataFormat())
